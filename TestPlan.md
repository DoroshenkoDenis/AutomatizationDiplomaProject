...
* Повторить Сценарий 1.1, используя номер месяца "13"
* Ожидаемый результат:
    * запрос в банк не отправляется
...
Сценарий 1.14 "Некорректный номер года 5"
* Повторить Сценарий 1.1, используя номер года "99"
* Ожидаемый результат:
    * запрос в банк не отправляется
    * предупреждение "Неверно указан срок действия карты"
...
* Повторить Сценарий 1.1, используя CVC/CVV "0"
* Ожидаемый результат:
    * запрос в банк не отправляется
    * предупреждение "Неверный формат"
...
Сценарий 1.18 "Некорректный номер CVC/CVV"
* Повторить Сценарий 1.1, используя CVC/CVV "55"
* Ожидаемый результат:
    * запрос в банк не отправляется
    * предупреждение "Неверный формат"
...
Сценарий 2.1 "Успешная покупка в кредит, использую карту "4441" status:APPROVED"
* Повторить Сценарий 1.1
* Ожидаемый результат:
    * уведомление "Операция одобрена Банком"

Сценарий 2.2 "Покупка в кредит через карту "4442" status:DECLINED"
...
* Отчёты - 3 рабочих для после код ревью.
